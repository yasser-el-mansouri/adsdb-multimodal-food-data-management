...
from app.utils.shared import PipelineConfig, S3Client, Logger, utc_timestamp, sanitize_filename, error_handler
...
class PersistentLandingProcessor:
    ...
    def __init__(self, config: PipelineConfig):
        ...
        # Index files no longer generated in this stage
    ...
    def copy_object(self, src_bucket: str, src_key: str, dst_bucket: str, dst_key: str,
        ...
        self.s3_client.copy_object(src_bucket, src_key, dst_bucket, dst_key, 
    ...
    def process(self) -> Dict[str, Any]:
        ...
        try:
            with error_handler(self.logger, "persistent_landing_processing"):
                ...
                # Index files are no longer generated in persistent landing
