...
class TestSimpleIntegration(unittest.TestCase):
    ...
    def test_utility_functions(self):
        ...
        from zones.shared_utils import utc_timestamp, sanitize_filename
        ...
        self.assertEqual(sanitized, "test_file_with_spaces_")  # Actual result includes trailing underscore
