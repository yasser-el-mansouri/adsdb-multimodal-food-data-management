...
from app.utils import PipelineConfig, Logger, utc_timestamp
...
class PipelineMonitor:
    ...
    def record_stage_start(self, stage_name: str):
        ...
        self.stage_metrics[stage_name] = {
            ...
            "start_disk": psutil.disk_usage('.').used
        }
    ...
    def record_stage_end(self, stage_name: str, result: Optional[Dict[str, Any]] = None):
        ...
        stage_memory = psutil.virtual_memory().used - stage_data["start_memory"]
        stage_disk = psutil.disk_usage('.').used - stage_data["start_disk"]
    ...
    def record_error(self, stage_name: str, error: str):
        ...
        error_data = {
            ...
            "error": error,
            "timestamp": utc_timestamp(),
            "memory_at_error": psutil.virtual_memory().used,
            "disk_at_error": psutil.disk_usage('.').used
        }
